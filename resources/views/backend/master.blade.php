...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li><a href="{{asset('admin/user')}}"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-male-user"/></svg> Người dùng</a></li>
			<li><a href="{{asset('admin/user')}}"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-clipboard-with-paper"/></svg> Đơn đặt hàng</a></li>
			<li role="presentation" class="divider"></li>
		</ul>
