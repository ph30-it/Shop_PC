							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
					                    ...
					                    <img id="avatar" class="thumbnail" width="300px" src="{{asset('./storage/app/avatar/'.$product->img)}}">
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
										...
										var editor = CKEDITOR.replace('description',{
											...
											filebrowserFlashUploadUrl: '../../layout/backend/public/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash',
										});
									</script>
									</div>
